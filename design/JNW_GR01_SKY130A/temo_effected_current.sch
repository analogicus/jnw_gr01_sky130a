...
N -70 110 210 110 {lab=GATE}
N -30 90 -30 120 {lab=RIGHT_SIDE}
N -50 90 -30 90 {lab=RIGHT_SIDE}
N -50 70 -50 90 {lab=RIGHT_SIDE}
...
C {JNW_GR01_SKY130A/SKY_OTA.sym} -70 -80 3 0 {name=x3}
