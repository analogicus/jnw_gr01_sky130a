...
C {JNW_ATR_SKY130A/JNWATR_PCH_4C5F0.sym} 210 -280 0 0 {name=xf}
...
C {JNW_ATR_SKY130A/JNWATR_PCH_4C5F0.sym} 540 -280 0 0 {name=xd1}
...
C {JNW_TR_SKY130A/JNWTR_RPPO2.sym} 250 30 1 0 {name=x1 }
C {JNW_TR_SKY130A/JNWTR_RPPO8.sym} 250 -190 1 0 {name=x2 }
