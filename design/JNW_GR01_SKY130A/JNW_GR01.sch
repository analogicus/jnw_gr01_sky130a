...
N -70 200 -50 200 {lab=reset}
N -70 200 -70 310 {lab=reset}
...
N -100 -20 -100 280 {lab=VSS}
N -120 280 -100 280 {lab=VSS}
N -460 280 -120 280 {lab=VSS}
N -460 270 -460 280 {lab=VSS}
N -120 280 -120 290 {lab=VSS}
...
N -120 350 -120 360 {lab=VSS}
N -460 140 -430 140 {lab=VDD}
N -460 -90 -120 -90 {lab=VDD}
N -120 290 -120 350 {lab=VSS}
