...
N 20 -220 310 -220 {lab=IB_GATE}
N -20 -340 -20 -250 {lab=VDD}
N -20 -190 -20 -140 {lab=IB_GATE}
...
N -20 -140 60 -140 {lab=IB_GATE}
N 60 -220 60 -140 {lab=IB_GATE}
N -20 -140 -20 -70 {lab=IB_GATE}
N -100 230 140 230 {lab=VSS}
N -20 160 -20 230 {lab=VSS}
N -20 -10 -20 100 {lab=#net4}
...
C {devices/res_ac.sym} 350 200 0 0 {name=R3
value=0
ac=0
m=1}
